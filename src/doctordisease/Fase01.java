...
public class Fase01 extends BasicGameState implements InputProviderListener{
    ...
    Image hp,health;
    static ArrayList<Line> EDGEmovement;
    static ArrayList<Line> EDGE;
...
//        g.drawString(Float.toString(guts.hp),900,50);
    ...
    public void update(GameContainer container, StateBasedGame game, int delta) throws SlickException {
        ...
        if(ThreadPlayer.guts.hp<=0 || ThreadBoss.boss.body.aIntro02.isStopped()){
...
//        System.out.println(t2-t1);
    ...
    public void controlPressed(Command command) {
           if (command.toString().contains("esc")) {
                ...
                ThreadPlayer.guts.pause();
                ThreadBoss.boss.pause();
            }
    }
